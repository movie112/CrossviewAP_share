...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="expt/sample/config_jp_10_eval.json", help="configuration filename")
    parser.add_argument("--result_dir", default="/home/yeonghwa/workspace/flitto/CrossviewAP_Share0522/datasets/result", help="save metrics")
